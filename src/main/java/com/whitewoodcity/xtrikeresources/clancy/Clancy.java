...
public class Clancy {
  ...
  public static final List<Action> BATTLE_UPPER_ACTIONS = List.of(ALERT, SHOOT, FIRE, FLAME);
  ...
  public static final List<Component> FLAME_COMPONENTS  = List.of(FLAMEA,FLAMEB,FLAMEC,FLAMED);
