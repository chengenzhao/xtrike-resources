...
public class Soldier {
  public static final List<Components> COMPONENTS       = List.of(LEFT_CALF,LEFT_SHOE,RIGHT_SHOE,RIGHT_CALF,RIGHT_THIGH,RIGHT_ARM,BODY,LEFT_THIGH,GUN,RIGHT_HAND,LEFT_ARM,HEAD,LEFT_SHOULDER);
