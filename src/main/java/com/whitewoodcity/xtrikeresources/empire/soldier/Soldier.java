...
public class Soldier {
    public static final List<JVGComponent> JVG_COMPONENTS = List.of(RIGHT_SHOE,RIGHT_CALF,RIGHT_THIGH,RIGHT_ARM,RIGHT_SHOULDER,CROTCH,LEFT_CALF,LEFT_SHOE,LEFT_THIGH,BODY,HEAD,GUN,RIGHT_HAND,LEFT_ARM,LEFT_SHOULDER);
    public static final List<JsonFile> ACTIONS = List.of(IDLE, WALK, ATTACK, THRUST);
}
