...
import static com.whitewoodcity.xtrikeresources.monsters.orcus.Action.*;
import static com.whitewoodcity.xtrikeresources.monsters.orcus.Components.*;

public class Orcus {
  public static final List<JVGComponent> JVG_COMPONENTS = List.of(RIGHT_THIGH, RIGHT_LEG, RIGHT_SHOE, RIGHT_HAND, RIGHT_ARM, BODY,LEFT_THIGH, LEFT_LEG, LEFT_SHOE,  LEFT_ARM, HEAD, POLE_AXE, LEFT_PALM,LEFT_HAND,RIGHT_PALM);
